...
public class Adder extends AbstractHandler {
	// 0 or 1
	private PipeLineSegment[] pipeline = new PipeLineSegment[ConstDefinition.OP_PILELINE_TIME[0].length];
	public Adder(ReserveStackEntry[] _group){
		super(_group);
		// 重新设置流水段
